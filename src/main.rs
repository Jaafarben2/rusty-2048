...
pub fn Home() -> Element {
    rsx!{
        ...
        div { class: "bg-[#faf8ef] min-h-[100dvh] pt-20",
            Navbar {}
            div { class: "text-3xl text-black", "Home - To be implemented" }
        }
    }
}
...
pub fn Classic2048() -> Element {
    rsx!{
        ...
        div { class: "bg-[#faf8ef] min-h-[100dvh] pt-20",
            Navbar {}
            div { class: "flex items-center justify-center", Classic2048Inner {} }
        }
    }
}
...
pub fn Classic2048Inner() -> Element {
    ...
    rsx! {
        div { class: "wrapper",
            ...
            div {
                class: "bg-[#bbada0] p-4 rounded-lg shadow-lg",
                style: "touch-action: none;",
                div {
                    id: "board",
                    class: "grid grid-cols-{c_width} gap-3",
                    tabindex: "0",
